...
config :pyro, :overrides, [Pyro.Overrides.Skeleton]
...
config :kantan, KantanWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: KantanWeb.ErrorHTML, json: KantanWeb.ErrorJSON],
    layout: false
  ],
...
config :kantan, Kantan.Mailer, adapter: Swoosh.Adapters.Local
