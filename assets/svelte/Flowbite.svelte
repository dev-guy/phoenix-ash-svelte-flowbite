...
const conicStops = [
	...
	{ color: 'rgb(var(--color-primary-500))', start: 85, end: 100 }
];
</script>

<Accordion>
	<AccordionItem open>
      <svelte:fragment slot="lead"><i class="fa-solid fa-book text-xl w-6 text-center">
...
<ConicGradient spin stops={conicStops}>Loading</ConicGradient>