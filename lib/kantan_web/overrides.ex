defmodule KantanWeb.Overrides do
  @moduledoc """
  ...
  @theme_colors ~w[slate gray zinc neutral stone red orange amber yellow lime green emerald teal cyan primary blue indigo violet purple fuchsia pink rose]
  ...
  @shared_link_class "font-black border-b-2 border-dotted text-slate-900 border-slate-900 dark:text-white dark:border-white hover:text-primary-500 hover:border-primary-500 active:text-primary-500 active:border-primary-500 active:border-solid"
  ...
  use Pyro.Overrides,
    ...
    @layer root {
      ::selection,
      ::-moz-selection {
        @apply text-white bg-primary-500 bg-opacity-100;
      }
      ...
      *::-webkit-scrollbar-thumb {
        @apply bg-primary-500 border-none rounded-full;
      }
  ...
  def button_class(passed_assigns) do
    ...
    [
      ...
      "bg-red-500 text-white": color == "primary" && variant == "solid",
      "border-primary-500 text-primary-500 bg-white hover:bg-primary-500 hover:text-white":
        color == "primary" && variant == "inverted",
      "border-primary-500 text-primary-500": color == "primary" && variant == "outline",
      "bg-blue-500 text-white": color == "primary" && variant == "solid",
  ...
  def flash_class(passed_assigns) do
    ...
    [
      ...
      "bg-primary-100 text-primary-900 ring-primary-500 fill-primary-900 dark:bg-primary-900 dark:text-primary-100 dark:ring-primary-500 dark:fill-primary-100":
        kind == "primary" || style_for_kind == "primary" || kind == "info" || style_for_kind == "info",
  ...
  def input_class(passed_assigns) do
    ...
    [
      ...
      "border-red-600 focus:border-red-600 focus:ring-red-600/10 dark:border-red-500 dark:focus:border-red-500 dark:focus:ring-red-500/25":
        errors?,
      "w-auto rounded text-primary-500 dark:text-primary-500": type == "checkbox",
  ...
  override Extra, :tooltip do
    set :class,
        "group hover:relative inline-block select-none hover:bg-primary-500 rounded cursor-help"
    ...
    set :tooltip_text_class,
        "bg-primary-500 text-white min-w-[20rem] p-2 rounded text-sm font-normal whitespace-pre"
