defmodule KantanWeb.AppShell do
      ...
      <nav class="border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
          ...
          <div class="flex items-center">
            ...
            <div class="btn-group variant-filled-surface h-7">
              <!-- Dark mode selection begin -->
              <button phx-click={JS.dispatch("pyro:theme-system")}>
                <.icon name="hero-computer-desktop-mini" />
              </button>
              <button phx-click={JS.dispatch("pyro:theme-dark")}>
                <.icon name="hero-moon-mini" />
              </button>
              <button phx-click={JS.dispatch("pyro:theme-light")}>
                <.icon name="hero-sun-mini" />
              </button>
              <!-- Dark mode selection end -->
              <!-- Sign in/sign out begin -->
              <%= if @current_user do %>
                <.button navigate={~p"/sign-out"}>
                  Sign Out
                </.button>
              <% else %>
                <.link
                  navigate={~p"/sign-in"}
                  data-tooltip-target="tooltip-sign-in"
                  data-tooltip-placement="bottom"
                >
                  <.icon name="hero-arrow-left-on-rectangle-mini" />
                </.link>
                <div
                  id="tooltip-sign-in"
                  role="tooltip"
            ...
            <div>
              ...
              <p class="font-medium leading-6 text-xs">
                ...
                >
                  ...
                  <div class="pl-3 w-full">
                    <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                      New message from <span class="font-semibold text-gray-900 dark:text-white">Bonnie Green</span>: "Hey, what's up? All
          ...
          <ul id="dropdown-pages" class="hidden py-2 space-y-2">
            ...
            <li>
              <.link
                ...
                class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              >
                Skeleton Accordion, Skeleton tabs, Mermaid, Named slots, Skeleton and Flowbite Toast
              </.link>
            </li>
          </ul>
        </li>
